...
// 			var account = Account.builder().accountNumber(accountNumber).balance(0d).build();
...
// 		assertThat(jobExecution.getExitStatus().getExitCode()).isEqualTo("FAILED");
// 		createAccount("1234567");
// 		var newExecution = jobLauncherTestUtils.launchJob(jobExecution.getJobParameters());
...
// 		createAccount("1234567");
// 		var jobExecution = jobLauncherTestUtils.launchJob(buildJobParameters("invalid_transactions.csv"));
// 		assertThat(jobExecution.getExitStatus().getExitCode()).isEqualTo("FAILED");
